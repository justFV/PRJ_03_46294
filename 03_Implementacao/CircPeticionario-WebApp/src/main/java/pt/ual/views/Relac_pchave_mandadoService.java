 ...
 import pt.ual.dao.Relac_pchave_mandado;
 import pt.ual.utils.Utils;

 @Path("relac_pchave_mandado")
 public class Relac_pchave_mandadoService
 {
   @GET
   ...
   public Response allConcelheiro(@PathParam("mandado") int mandado, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_pchave_mandado ptr = new Relac_pchave_mandado();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_pchave_mandado ptr = (Relac_pchave_mandado)(new ObjectMapper()).readValue(data, Relac_pchave_mandado.class);
   ...
   @PUT
   @Path("/updatePalavraChave/{mandado}")
   @Produces({"application/json"})
   ...
   @DELETE
   @Path("/delete/{mandado}/{palavra_chave}")
   @Produces({"application/json"})
   public Response delete(@PathParam("mandado") int mandado, @PathParam("palavra_chave") int palavra_chave, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_pchave_mandado ptr = new Relac_pchave_mandado();
     String token = (new Utils()).getToken();
