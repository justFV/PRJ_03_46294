 ...
 import pt.ual.dao.Relac_comarca_ultramar;
 import pt.ual.utils.Utils;

 @Path("relac_comarca_ultramar")
 public class Relac_comarca_ultramarService
 {
   @GET
   ...
   public Response allComarcas(@PathParam("comarca") int comarca, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_comarca_ultramar ptr = new Relac_comarca_ultramar();
   ...
   @Produces({"application/json"})
   public Response allProvocacao(@PathParam("ultramar") int ultramar, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_comarca_ultramar ptr = new Relac_comarca_ultramar();
     String token = (new Utils()).getToken();
   ...
   @Produces({"application/json"})
   public Response notInProvocacao(@PathParam("ultramar") int ultramar, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_comarca_ultramar ptr = new Relac_comarca_ultramar();
     String token = (new Utils()).getToken();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_comarca_ultramar ptr = (Relac_comarca_ultramar)(new ObjectMapper()).readValue(data, Relac_comarca_ultramar.class);
   ...
   @DELETE
   @Path("/delete/{comarca}/{ultramar}")
   @Produces({"application/json"})
   public Response delete(@PathParam("comarca") int comarca, @PathParam("ultramar") int ultramar, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_comarca_ultramar ptr = new Relac_comarca_ultramar();
     String token = (new Utils()).getToken();
