 ...
 import pt.ual.dao.Oficio_agregador;
 import pt.ual.utils.Utils;

 @Path("oficio_agregador")
 public class Oficio_agregadorService
 {
   @GET
   ...
   public Response getAll(@PathParam("pageNum") int pageNum, @PathParam("rowsPage") int rowsPage, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Oficio_agregador list = new Oficio_agregador();
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Oficio_agregador row = list.allOficioAgregador();
         b = Response.ok(row);
       } 
     } catch (Exception ex) {
   ...
   public Response record(@PathParam("oficio_agregador_id") int oficio_agregador_id, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Oficio_agregador ptr = new Oficio_agregador();
     String token = (new Utils()).getToken();
     ptr.setOficio_agregador_id(oficio_agregador_id);
     try {
       if (authKey == null || !authKey.equals(token)) {
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Oficio_agregador ptr = (Oficio_agregador)(new ObjectMapper()).readValue(data, Oficio_agregador.class);
