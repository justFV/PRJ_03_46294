 ...
 import pt.ual.dao.Relac_termo_ultramar;
 import pt.ual.utils.Utils;

 @Path("relac_termo_ultramar")
 public class Relac_termo_ultramarService
 {
   @GET
   ...
   public Response allTermos(@PathParam("termo") int termo, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_termo_ultramar ptr = new Relac_termo_ultramar();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_termo_ultramar ptr = (Relac_termo_ultramar)(new ObjectMapper()).readValue(data, Relac_termo_ultramar.class);
   ...
   @PUT
   @Path("/updateTermo/{ultramar}")
   @Produces({"application/json"})
   public Response updateTermo(String data, @PathParam("ultramar") int ultramar, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     String token = (new Utils()).getToken();
   ...
   @DELETE
   @Path("/delete/{termo}/{ultramar}")
   @Produces({"application/json"})
   public Response delete(@PathParam("termo") int termo, @PathParam("ultramar") int ultramar, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_termo_ultramar ptr = new Relac_termo_ultramar();
     String token = (new Utils()).getToken();
