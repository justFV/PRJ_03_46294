 ...
 import pt.ual.dao.Relac_ultramar_consulta;
 import pt.ual.utils.Utils;

 @Path("relac_ultramar_consulta")
 public class Relac_ultramar_consultaService
 {
   @GET
   ...
   public Response allUltramar(@PathParam("ultramar") int ultramar, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_ultramar_consulta ptr = new Relac_ultramar_consulta();
   ...
   public Response notInConsulta(String data, @PathParam("consulta") int consulta, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     String token = (new Utils()).getToken();
     Relac_ultramar_consulta ptr = (Relac_ultramar_consulta)(new ObjectMapper()).readValue(data, Relac_ultramar_consulta.class);
     ptr.setNomePesq(nomePesq);
     ptr.setConsulta(consulta);
     try {
       if (authKey == null || !authKey.equals(token)) {
   ...
   @PUT
   @Path("/updateUltramar/{consulta}")
   @Produces({"application/json"})
   public Response updateUltramar(String data, @PathParam("consulta") int consulta, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     String token = (new Utils()).getToken();
   ...
   @DELETE
   @Path("/delete/{ultramar}/{consulta}")
   @Produces({"application/json"})
   public Response delete(@PathParam("ultramar") int ultramar, @PathParam("consulta") int consulta, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_ultramar_consulta ptr = new Relac_ultramar_consulta();
     String token = (new Utils()).getToken();
