 ...
 import pt.ual.dao.Relac_comarca_provocacao;
 import pt.ual.utils.Utils;

 @Path("relac_comarca_provocacao")
 public class Relac_comarca_provocacaoService
 {
   @GET
   ...
   public Response allComarcas(@PathParam("comarca") int comarca, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_comarca_provocacao ptr = new Relac_comarca_provocacao();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_comarca_provocacao ptr = (Relac_comarca_provocacao)(new ObjectMapper()).readValue(data, Relac_comarca_provocacao.class);
   ...
   @DELETE
   @Path("/delete/{comarca}/{provocacao}")
   @Produces({"application/json"})
   public Response delete(@PathParam("comarca") int comarca, @PathParam("provocacao") int provocacao, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_comarca_provocacao ptr = new Relac_comarca_provocacao();
     String token = (new Utils()).getToken();
