 ...
 import pt.ual.dao.Relac_freguesia_mandado;
 import pt.ual.utils.Utils;

 @Path("relac_freguesia_mandado")
 public class Relac_freguesia_mandadoService
 {
   @GET
   ...
   public Response allFreguesias(@PathParam("freguesia") int freguesia, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_freguesia_mandado ptr = new Relac_freguesia_mandado();
   ...
   @Produces({"application/json"})
   public Response allMandados(@PathParam("mandado") int mandado, @PathParam("nomePesq") String nomePesq, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_freguesia_mandado ptr = new Relac_freguesia_mandado();
     String token = (new Utils()).getToken();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_freguesia_mandado ptr = (Relac_freguesia_mandado)(new ObjectMapper()).readValue(data, Relac_freguesia_mandado.class);
   ...
   @PUT
   @Path("/updateMandado/{freguesia}")
   @Produces({"application/json"})
   public Response updateMandado(String data, @PathParam("freguesia") int freguesia, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     String token = (new Utils()).getToken();
   ...
   @DELETE
   @Path("/delete/{freguesia}/{mandado}")
   @Produces({"application/json"})
   public Response delete(@PathParam("freguesia") int freguesia, @PathParam("mandado") int mandado, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_freguesia_mandado ptr = new Relac_freguesia_mandado();
     String token = (new Utils()).getToken();
