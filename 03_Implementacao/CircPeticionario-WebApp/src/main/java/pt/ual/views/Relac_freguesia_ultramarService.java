 ...
 import pt.ual.dao.Relac_freguesia_ultramar;
 import pt.ual.utils.Utils;

 @Path("relac_freguesia_ultramar")
 public class Relac_freguesia_ultramarService
 {
   @GET
   ...
   public Response allFreguesias(@PathParam("freguesia") int freguesia, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     Relac_freguesia_ultramar ptr = new Relac_freguesia_ultramar();
   ...
   public Response insert(String data, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     ...
     try {
       if (authKey == null || !authKey.equals(token)) {
         ...
         Relac_freguesia_ultramar ptr = (Relac_freguesia_ultramar)(new ObjectMapper()).readValue(data, Relac_freguesia_ultramar.class);
   ...
   @PUT
   @Path("/updateUltramar/{freguesia}")
   @Produces({"application/json"})
   public Response updateUltramar(String data, @PathParam("freguesia") int freguesia, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     String token = (new Utils()).getToken();
   ...
   @DELETE
   @Path("/delete/{freguesia}/{ultramar}")
   @Produces({"application/json"})
   public Response delete(@PathParam("freguesia") int freguesia, @PathParam("ultramar") int ultramar, @Context HttpHeaders headers, @HeaderParam("token") String authKey) throws Exception {
     boolean result = false;
     Response.ResponseBuilder response = null;
     Relac_freguesia_ultramar ptr = new Relac_freguesia_ultramar();
     String token = (new Utils()).getToken();
