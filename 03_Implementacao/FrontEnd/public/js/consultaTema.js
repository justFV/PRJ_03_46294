...
async function getAllTemasCon(pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/tema/consultaTema/" + pageNum + "/" + rowsPage;
    ...
    await fetch(myRequest).then(async function (response) {
        if (!response.ok) {
            ...
            temas = objPes.allTemas;
            let tabela = '<table class="table" id="consPessoa" style="text-align: center;">' +
                `<tr>` +
                `<th scope="col" style="background:#b91d47; color:#fff;">Tema</th><th scope="col" style="background:#b91d47; color:#fff;">Agregador</th><th scope="col" style="background:#F7464A;">Provocação</th><th scope="col" style="background:#E2EAE9;">Mandado</th>` +
            ...
            for (const tema of temas) {
                tabela += `<tr>
                                <td scope="row" style="background:#b91d47; color:#fff;">` + tema.tema + `</td>
                                <td scope="row" style="background:#b91d47; color:#fff;">dd` + tema.agregadordesc + `</td>`
                if (tema.provnum > 0) {
                    tabela += `<td scope="row" style="background:#F7464A;"><a href="javascript:openDetalhe(` + tema.pk_tema + `,'` + tema.tema + `','Prova')">` + tema.provnum + `</a></td>`;
                } else {
                    tabela += `<td scope="row" style="background:#F7464A;">` + tema.provnum + `</td>`;
                }

                if (tema.mannum > 0) {
                    tabela += `<td scope="row" style="background:#E2EAE9;"><a href="javascript:openDetalhe(` + tema.pk_tema + `,'` + tema.tema + `','Mando')">` + tema.mannum + `<a></td>`;
                } else {
                    tabela += `<td scope="row" style="background:#E2EAE9;">` + tema.mannum + `</td>`;
                }

                if (tema.connum > 0) {
                    tabela += `<td scope="row" style="background:#D4CCC5;"><a href="javascript:openDetalhe(` + tema.pk_tema + `,'` + tema.tema + `','Con')">` + tema.connum + `<a></td>`;
                } else {
                    tabela += `<td scope="row" style="background:#D4CCC5;">` + tema.connum + `</td>`;
                }

                if (tema.ultranum > 0) {
                    tabela += `<td scope="row" style="background:#949FB1;"><a href="javascript:openDetalhe(` + tema.pk_tema + `,'` + tema.tema + `','Ultra')">` + tema.ultranum + `<a></td>`;
                } else {
                    tabela += `<td scope="row" style="background:#949FB1;">` + tema.ultranum + `</td>`;
                }

                if (tema.resnum > 0) {
                    tabela += `<td scope="row" style="background:#4D5360; color:#fff;"><a href="javascript:openDetalhe(` + tema.pk_tema + `,'` + tema.tema + `','Res')">` + tema.resnum + `<a></td>`;
                } else {
                    tabela += `<td scope="row" style="background:#4D5360; color:#fff;">` + tema.resnum + `</td>`;
                }
                tabela += `</tr>`
            }
            tabela += `</table>`;
            ...
            if (pageNum != 1) {
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllTemasCon(1,` + rowsPage + `)" style="color: white;">Inicio</a></span></li>`;
                if (pageNum > 5) {
            ...
            for (let i = 1; i <= numPage; i++) {
                if (i == pageNum) {
                    ...
                    if (i > pageNum - 5 && i < pageNum + 5) {
                        tabela += ` <li class="page-item"><a class="page-link" href="javascript:getAllTemasCon(` + i + `,` + rowsPage + `)">` + i + `</a></li>`;
                    }
                }
            }
            if (pageNum != numPage) {
                ...
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllTemasCon(` + numPage + `,` + rowsPage + `)" style="color: white;">Fim</a></span></li>`;
            }
            tabela += `</ul> `;
...
async function getAllProvTema(v_idTema, tema, pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/provocacao/getConTemaProvoca/" + v_idTema + "/" + pageNum + "/" + rowsPage;
    var myHeaders = new Headers();
    myHeaders.append("token", await getToken());
    ...
    await fetch(myRequest).then(async function (response) {
        if (!response.ok) {
            ...
            if (pageNum != 1) {
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllProvTema(` + v_idTema + `, '` + tema + `',1,` + rowsPage + `)" style="color: white;">Inicio</a></span></li>`;
                if (pageNum > 5) {
                    tabela += `<li class="page-item"><span class="page-link" >. . .</span></li>`;
                }
            }
            for (let i = 1; i <= numPage; i++) {
                if (i == pageNum) {
                    ...
                    if (i > pageNum - 5 && i < pageNum + 5) {
                        tabela += ` <li class="page-item"><a class="page-link" href="javascript:getAllProvTema(` + v_idTema + `, '` + tema + `',` + i + `,` + rowsPage + `)">` + i + `</a></li>`;
                    }
                }
            }
            if (pageNum != numPage) {
                ...
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllProvTema(` + v_idTema + `, '` + tema + `',` + numPage + `,` + rowsPage + `)" style="color: white;">Fim</a></span></li>`;
            }
            tabela += `</ul> `;
            document.getElementById("tituloDetalhe").innerHTML = "<b>Prvocações</b>";
            document.getElementById("nomePes").innerHTML = "" + tema;
...
async function getAllMandoTema (v_idPes, pesNome, pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/mandado/getConTemaMandado/" + v_idPes + "/" + pageNum + "/" + rowsPage;
    ...
    await fetch(myRequest).then(async function (response) {
        if (!response.ok) {
            ...
            let numPage = Math.ceil(objProv.rowcount / rowsPage);
            if (pageNum != 1) {
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllMandoTema(` + v_idPes + `,'` + pesNome + `',1,` + rowsPage + `)" style="color: white;">Inicio</a></span></li>`;
                if (pageNum > 5) {
                    tabela += `<li class="page-item"><span class="page-link" >. . .</span></li>`;
                }
            }
            for (let i = 1; i <= numPage; i++) {
                if (i == pageNum) {
                    ...
                    if (i > pageNum - 5 && i < pageNum + 5) {
                        tabela += ` <li class="page-item"><a class="page-link" href="javascript:getAllMandoTema(` + v_idPes + `,'` + pesNome + `',` + i + `,` + rowsPage + `)">` + i + `</a></li>`;
                    }
                }
            }
            if (pageNum != numPage) {
                ...
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllMandoTema(` + v_idPes + `,'` + pesNome + `',` + numPage + `,` + rowsPage + `)" style="color: white;">Fim</a></span></li>`;
            }
            tabela += `</ul> `;
...
async function getAllTemaCon(v_idPes, pesNome, pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/consulta/getConTemaConsulta/" + v_idPes + "/" + pageNum + "/" + rowsPage;
...
async function getAllUltraTema(v_idPes, pesNome, pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/ultramar/getConTemaUltramar/" + v_idPes + "/" + pageNum + "/" + rowsPage;
    ...
    await fetch(myRequest).then(async function (response) {
        if (!response.ok) {
            ...
            let numPage = Math.ceil(objProv.rowcount / rowsPage);
            if (pageNum != 1) {
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllUltraTema(` + v_idPes + `,'` + pesNome + `',1,` + rowsPage + `)" style="color: white;">Inicio</a></span></li>`;
                if (pageNum > 5) {
                    tabela += `<li class="page-item"><span class="page-link" >. . .</span></li>`;
                }
            }
            for (let i = 1; i <= numPage; i++) {
                if (i == pageNum) {
                    ...
                    if (i > pageNum - 5 && i < pageNum + 5) {
                        tabela += ` <li class="page-item"><a class="page-link" href="javascript:getAllUltraTema(` + v_idPes + `,'` + pesNome + `',` + i + `,` + rowsPage + `)">` + i + `</a></li>`;
                    }
                }
            }
            if (pageNum != numPage) {
                ...
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllUltraTema(` + v_idPes + `,'` + pesNome + `',` + + numPage + `,` + rowsPage + `)" style="color: white;">Fim</a></span></li>`;
            }
            tabela += `</ul> `;
...
async function getAllResTema(v_idPes, pesNome, pageNum, rowsPage) {

    const urlBase = await getUrlPayaraDireto() + "/CircPeticionario/webresources/resposta/getConTematResposta/" + v_idPes + "/" + pageNum + "/" + rowsPage;
    ...
    await fetch(myRequest).then(async function (response) {
        if (!response.ok) {
            ...
            let numPage = Math.ceil(objProv.rowcount / rowsPage);
            if (pageNum != 1) {
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllResTema(` + v_idPes + `,'` + pesNome + `',1,` + rowsPage + `)" style="color: white;">Inicio</a></span></li>`;
                if (pageNum > 5) {
                    tabela += `<li class="page-item"><span class="page-link" >. . .</span></li>`;
                }
            }
            for (let i = 1; i <= numPage; i++) {
                if (i == pageNum) {
                    ...
                    if (i > pageNum - 5 && i < pageNum + 5) {
                        tabela += ` <li class="page-item"><a class="page-link" href="javascript:getAllResTema(` + v_idPes + `,'` + pesNome + `',` + i + `,` + rowsPage + `)">` + i + `</a></li>`;
                    }
                }
            }
            if (pageNum != numPage) {
                ...
                tabela += `<li class="page-item active"><span class="page-link" ><a href="javascript:getAllResTema(` + v_idPes + `,'` + pesNome + `',` + + numPage + `,` + rowsPage + `)" style="color: white;">Fim</a></span></li>`;
            }
            tabela += `</ul> `;
...
async function openDetalhe(v_pesId, v_tema, v_tab, v_pess) {
    if (v_tab == 'Prova') {
        getAllProvTema(v_pesId, v_tema, 1, 10);
    } else {
        if (v_tab == 'Mando') {
            getAllMandoTema(v_pesId, v_tema, 1, 10);

        } else {
            if (v_tab == 'Con') {
                getAllTemaCon(v_pesId, v_tema, 1, 10);

            } else {
                if (v_tab == 'Ultra') {
                    getAllUltraTema(v_pesId, v_tema, 1, 10);

                } else {
                    if (v_tab == 'Res') {
                        getAllResTema(v_pesId, v_tema, 1, 10);
